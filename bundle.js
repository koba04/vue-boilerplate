...
},{"./batcher":6,"./compiler":8,"./transition":30,"./utils":31}],33:[function(require,module,exports){
...
var __vue_template__ = "<div v-view=\"view\" v-animation=\"\"></div>";
module.exports = {
  el: '#app',
  className: "container",
  data: {
...
},{"insert-css":2}],34:[function(require,module,exports){
...
module.exports = {
  ...
  methods: {
    fetchTopTracks: function() {
      return request.get("http://ws.audioscrobbler.com/2.0/?api_key=b867bf0fdfe95e6c6dc31a275535f765&format=json&method=artist.gettoptracks&artist=" + this.artist, (function(_this) {
        return function(res) {
...
},{"./input-artist.vue":38,"./nav.vue":39,"./tracks.vue":42,"insert-css":2,"superagent":3}],35:[function(require,module,exports){
...
},{"./nav.vue":39,"./select-country.vue":40,"./tracks.vue":42,"insert-css":2,"superagent":3}],36:[function(require,module,exports){
...
},{"./app.vue":33,"./artist.vue":34,"./country.vue":35,"./footer.vue":36,"./top.vue":41,"director":1,"vue":26}],38:[function(require,module,exports){
...
module.exports = {
  methods: {
    fetch: function(e) {
      e.preventDefault();
      return this.$parent.fetchTopTracks();
    }
  }
};
...
},{"insert-css":2}],40:[function(require,module,exports){
